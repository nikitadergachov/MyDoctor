...
public class ProcedureArrayAdapter extends ArrayAdapter<String> {
    ...
    public ProcedureArrayAdapter(Activity context, String[] name, int[] count, String[] time, String[] time_check) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tabletCount.setText("Продолжительность " + count[position] + "мин");
        tabletTime.setText(time[position]);
        if(this.time_check[position] != null){
            checkTime.setText("Выполненно " + time_check[position]);
